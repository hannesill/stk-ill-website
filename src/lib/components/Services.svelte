  ...
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {#each services as service}
        <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group">
          {#if service.image}
            <img 
              src={service.image} 
              alt={service.title}
          ...
          <div class="p-6">
            ...
            <a href={service.href} class="text-secondary hover:text-secondary-dark font-medium inline-flex items-center group-hover:translate-x-1 transition-transform">
              Mehr erfahren 
