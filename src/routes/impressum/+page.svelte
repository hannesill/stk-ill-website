...
<svelte:head>
  <title>Impressum | Steuerkanzlei am Bodensee</title>
  <meta name="description" content="Impressum der Steuerkanzlei Ill in Stockach, Singen und Radolfzell am Bodensee." />
</svelte:head>
